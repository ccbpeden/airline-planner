# **Airline Planne**
#### Charles Peden & Maggie Harrington, 2/24/2017

&nbsp;
## Description
A sample Airline Planner
...
* Go to my [Github repository] (https://github.com/ccbpeden/airline-planner)
* Download the zip file via the green button
* Unzip the file and open the **airline-planner** folder
* Open Terminal, navigate to **airline-planner** project folder, type **_composer install_** and hit enter
* Navigate Terminal to the **airline-planner/web** folder and set up a server by typing **_php -S localhost:8000_**
...
Copyright (c) 2017 Charles Peden & Maggie Harrington
